...
class ProductInfo {
  ...
  factory ProductInfo.fromJson(Map<String, dynamic> json) => ProductInfo(
    ...
    name: json["name"],
    price: json["price"],
    priceSign: priceSignValues.map[json["price_sign"]] ?? null,
    currency: currencyValues.map[json["currency"]] ?? null,
    imageLink: json["image_link"] ?? 'https://picsum.photos/100/300',
    productLink: json["product_link"],
    websiteLink: json["website_link"],
    description: json["description"],
    rating: json["rating"]?.toDouble(),
    category: categoryValues.map[json["category"]] ?? null,
